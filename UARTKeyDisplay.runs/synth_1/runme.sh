...
HD_PWD='C:/Users/danny/OneDrive/Desktop/FPGA/UARTKeyDisplay/UARTKeyDisplay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UARTKeyDisplay_top_entity.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UARTKeyDisplay_top_entity.tcl
