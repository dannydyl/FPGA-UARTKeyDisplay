...
HD_PWD='C:/Users/danny/OneDrive/Desktop/FPGA/UARTKeyDisplay/UARTKeyDisplay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UARTKeyDisplay_top_entity.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UARTKeyDisplay_top_entity.tcl -notrace
